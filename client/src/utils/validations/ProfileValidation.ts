...
//   fullName: z
//     .string()
//     .min(3, 'Full name is required and must be a minimum of 3 characters')
//     .max(100, 'Full name must be minimum 3 characters')
//     .trim(),
//   companyName: z
//     .string()
//     .max(100, 'Company name must be 100 characters or less')
//     .optional()
//     .transform((val) => (val ? val.trim() : '')), // Convert empty string to ''
//   description: z
//     .string()
//     .min(8, 'Description is required and must be at least 8 characters long')
...
//     description: z
//       .string()
//       .min(8, 'Bio is required and must be at least 8 characters long')
